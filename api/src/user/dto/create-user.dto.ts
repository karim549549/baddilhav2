...
export class CreateUserDto {
  ...
  @ApiPropertyOptional({ description: 'User bio/description', example: 'Passionate gamer looking to trade items' })
  @IsOptional()
  @IsString()
  bio?: string;
  ...
  @ApiPropertyOptional({ description: 'User date of birth', example: '1995-01-01' })
  @IsOptional()
  @IsDateString()
  dateOfBirth?: string;

  @ApiPropertyOptional({ description: 'User verification status', enum: UserVerificationStatus })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'User location latitude', example: 40.7128 })
  @IsOptional()
  @IsNumber()
  @Min(-90)
  @Max(90)
  ...
  @ApiPropertyOptional({ description: 'User location longitude', example: -74.0060 })
  @IsOptional()
  @IsNumber()
  @Min(-180)
  @Max(180)
  ...
  @ApiPropertyOptional({ description: 'User location address', example: 'New York, NY, USA' })
  @IsOptional()
  @IsString()
  address?: string;

  @ApiPropertyOptional({ description: 'Maximum distance for item discovery (in km)', example: 50 })
  @IsOptional()
  @IsNumber()
  @Min(1)
  @Max(1000)
  ...
  @ApiPropertyOptional({ description: 'Games the user is interested in', example: ['Call of Duty', 'Fortnite', 'Valorant'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  interestedGames?: string[];

  @ApiPropertyOptional({ description: 'User preferences for notifications', example: { matches: true, messages: true, system: false } })
  @IsOptional()
  preferences?: {
    matches?: boolean;
    messages?: boolean;
